...
1. Download [Healthcare_Appointment_Performance_.xlsx](Healthcare_Appointment_Performance_.xlsx).
2. Open it in the desktop version of Microsoft Excel.
3. Select **Data → Refresh All** to refresh the Power Query pipeline and PivotTables.
4. Open the `Dashboard` worksheet.
5. Use the slicers and timeline to explore clinic, booking-channel and monthly performance.
6. Clear the filters before closing the workbook to return the dashboard to its full-period view.
...
- `Healthcare_Appointment_Performance_.xlsx` — completed Excel workbook
